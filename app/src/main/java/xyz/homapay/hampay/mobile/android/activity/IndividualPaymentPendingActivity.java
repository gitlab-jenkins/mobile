...
public class IndividualPaymentPendingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_individual_payment_pending);

        context = this;
        activity = IndividualPaymentPendingActivity.this;
...
//                        contactPhoneNo = PhoneNumberUtils.stripSeparators(contactPhoneNo);
        ...
        contact_name.setText(contactPhoneNo);
