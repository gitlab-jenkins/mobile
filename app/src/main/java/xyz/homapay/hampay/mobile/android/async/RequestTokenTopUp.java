 ...
 */
public class RequestTokenTopUp extends AsyncTask<TopUpTokenDoWork, Void, HHBArrayOfKeyValueOfstringstring> {

    private static final String TAG = "RequestTokenTopUp";
    ...
    public RequestTokenTopUp(Context context, AsyncTaskCompleteListener<HHBArrayOfKeyValueOfstringstring> listener, String payUrl) {
