package com.hampay.mobile.android.account;
...
public class AccountGeneral {
     ...
     * Account type id
     */
    public static final String ACCOUNT_TYPE = "com.nemezis.sample.contacts";
    public static final String ACCOUNT_NAME = "aaaa";
